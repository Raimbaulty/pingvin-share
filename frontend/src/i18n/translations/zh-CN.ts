export default {
  ...
  "resetPassword.description": "请输入电子邮件地址来接收重置密码邮件",
  "resetPassword.notify.success": "系统已向您的邮箱发送一条包含重置密码链接的邮件。（若该电子邮件地址存在）",
  ...
  "account.card.password.noPasswordSet": "您还未设置密码。如果您想通过电子邮件和密码登录，请先设置密码。",
  ...
  "account.card.oauth.linuxdo": "Linux Do",
  ...
  "account.card.security.totp.enable.description": "请输入当前密码启用两步验证",
  "account.card.security.totp.disable.description": "请输入当前密码禁用两步验证",
  "account.card.security.totp.button.start": "启用",
  "account.modal.totp.title": "启用两步验证",
  ...
  "account.notify.totp.disable": "成功禁用两步验证！",
  "account.notify.totp.enable": "成功启用两步验证！",
  ...
  "upload.modal.accordion.email.invalid-email": "电子邮件地址无效",
  ...
  "admin.config.cache.ttl.description": "缓存中保留信息的时间（秒）",
  "admin.config.cache.max-items": "最大项目数",
  "admin.config.cache.max-items.description": "缓存中的最大项目数量",
  "admin.config.cache.redis-enabled": "启用Redis",
  "admin.config.cache.redis-enabled.description": "通常Pingvin Share在内存中缓存信息。如果您运行多个Pingvin Share实例，需要启用Redis缓存以在实例之间共享缓存。",
  "admin.config.cache.redis-url": "Redis URL",
  "admin.config.cache.redis-url.description": "连接到用于缓存的Redis实例的URL",
  "admin.config.email.enable-share-email-recipients": "启用邮件收件人共享",
  "admin.config.email.enable-share-email-recipients.description": "是否允许与收件人分享电子邮件。只有在SMTP被启用时才启用此功能。",
  ...
  "admin.config.smtp.enabled.description": "是否启用 SMTP，仅当输入主机名、端口、发送邮件地址、用户名和密码后启用",
  ...
  "admin.config.smtp.email": "发送邮件地址",
  ...
  "admin.config.smtp.allow-unauthorized-certificates.description": "仅在需要信任自签名证书时将其启用",
  ...
  "admin.config.oauth.github-client-id": "GitHub 客户端ID",
  "admin.config.oauth.github-client-id.description": "GitHub OAuth App 的客户端ID",
  "admin.config.oauth.github-client-secret": "GitHub 客户端密钥",
  "admin.config.oauth.github-client-secret.description": "GitHub OAuth App 的客户端密钥",
  "admin.config.oauth.google-enabled": "谷歌",
  "admin.config.oauth.google-enabled.description": "是否启用谷歌账号登录",
  "admin.config.oauth.google-client-id": "谷歌 客户端ID",
  "admin.config.oauth.google-client-id.description": "Google OAuth App 的客户端ID",
  "admin.config.oauth.google-client-secret": "谷歌 客户端密钥",
  "admin.config.oauth.google-client-secret.description": "Google OAuth App 的客户端密钥",
  ...
  "admin.config.oauth.microsoft-tenant.description": "Microsoft OAuth App 的租户（Tenant）ID，共有四种类型，参阅https://learn.microsoft.com/zh-cn/security/zero-trust/develop/identity-supported-account-types。\ncommon（常规）：个人 Microsoft 账户和 Microsoft Entra ID 工作或学校账户均可登录。\norganizations（组织）：只有Microsoft Entra ID 工作或学校账户可以登录。\nconsumers（客户）：只有个人 Microsoft 账户可以登录。\nMicrosoft Entra 租户的域名或 GUID 格式的租户 ID：只有来自特定 Microsoft Entra 租户的用户（具有工作或学校账户的目录成员或具有个人 Microsoft 账户的目录来宾）才能登录。",
  "admin.config.oauth.microsoft-client-id": "Microsoft 客户端ID",
  "admin.config.oauth.microsoft-client-id.description": "Microsoft OAuth App 的客户端ID",
  "admin.config.oauth.microsoft-client-secret": "Microsoft 客户端密钥",
  "admin.config.oauth.microsoft-client-secret.description": "Microsoft OAuth App 的客户端密钥",
  ...
  "admin.config.oauth.discord-limited-guild": "Discord 受限服务器ID",
  "admin.config.oauth.discord-limited-guild.description": "限制特定服务器中的用户登录。留空来禁用。",
  "admin.config.oauth.discord-client-id": "Discord 客户端ID",
  "admin.config.oauth.discord-client-id.description": "Discord OAuth App 的客户端ID",
  "admin.config.oauth.discord-client-secret": "Discord 客户端密钥",
  "admin.config.oauth.discord-client-secret.description": "Discord OAuth App 的客户端密钥",
  ...
  "admin.config.oauth.oidc-role-path.description": "必须是引用角色数组的有效JMES路径。" + "只有在没有配置其他身份提供商且密码登录被禁用的情况下，才建议使用 OpenID Connect 角色来管理访问权限。 " + "如果您不知道此配置是什么，请留空。",
  ...
  "admin.config.oauth.oidc-client-id": "OpenID Connect 客户端ID",
  "admin.config.oauth.oidc-client-id.description": "OpenID Connect OAuth App 的客户端ID",
  "admin.config.oauth.oidc-client-secret": "OpenID Connect 客户端密钥",
  "admin.config.oauth.oidc-client-secret.description": "OpenID Connect OAuth App 的客户端密钥",
  ...
  "admin.config.ldap.admin-groups.description": "管理员访问所需的群组",
  "admin.config.ldap.field-name-member-of": "用户群组属性名称",
  "admin.config.ldap.field-name-member-of.description": "用户所属群组的LDAP属性名称。在检查管理员群组时使用此属性。",
  "admin.config.ldap.field-name-email": "用户电子邮件属性名称",
  "admin.config.ldap.field-name-email.description": "用户电子邮件的LDAP属性名称",
  ...
  "admin.config.s3.endpoint": "端点",
  "admin.config.s3.endpoint.description": "S3存储桶的URL地址",
  "admin.config.s3.region": "区域",
  "admin.config.s3.region.description": "S3存储桶的区域",
  "admin.config.s3.bucket-name": "存储桶名称",
  "admin.config.s3.bucket-name.description": "S3存储桶的名称",
  "admin.config.s3.bucket-path": "路径",
  "admin.config.s3.bucket-path.description": "用于在 S3 桶中存储文件的默认路径。",
  "admin.config.s3.key": "访问密钥",
  "admin.config.s3.key.description": "允许您访问 S3 桶的访问密钥",
  "admin.config.s3.secret": "密钥",
  "admin.config.s3.secret.description": "允许您访问 S3 桶的密钥",
  "admin.config.s3.use-checksum": "使用校验和",
  "admin.config.s3.use-checksum.description": "对于不支持校验和的后端（如B2），请关闭此选项",
  ...
  "error.msg.no_email": "无法从 {0} 这个账户获取电子邮件地址。",
  ...
  "error.param.provider_linuxdo": "Linux Do",
  // Common translations
  ...
  "common.error.invalid-email": "电子邮件地址无效",
  ...
  "admin.config.oauth.linuxdo-enabled": "Linux Do",
  "admin.config.oauth.linuxdo-enabled.description": "是否启用 Linux Do OAuth 登录",
  "admin.config.oauth.linuxdo-client-id": "Linux Do 客户端ID",
  "admin.config.oauth.linuxdo-client-id.description": "Linux Do OAuth App 的客户端ID",
  "admin.config.oauth.linuxdo-client-secret": "Linux Do 客户端密钥",
  "admin.config.oauth.linuxdo-client-secret.description": "Linux Do OAuth App 的客户端密钥"
};